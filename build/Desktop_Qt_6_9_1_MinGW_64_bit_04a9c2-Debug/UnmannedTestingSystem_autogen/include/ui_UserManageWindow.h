...
public:
    ...
    void setupUi(QWidget *UserManageWindow)
    {
        ...
        UserManageWindow->resize(940, 650);
        UserManageWindow->setStyleSheet(QString::fromUtf8("\n"
"    background-color: #f5f7fa;\n"
"    font-family: \"Microsoft YaHei\", \"Segoe UI\", sans-serif;\n"
"   "));
        verticalLayout = new QVBoxLayout(UserManageWindow);
        verticalLayout->setSpacing(12);
        verticalLayout->setObjectName("verticalLayout");
        verticalLayout->setContentsMargins(12, 12, 12, 12);
        buttonContainer = new QWidget(UserManageWindow);
...
"         "));
        ...
        tableUsers = new QTableWidget(UserManageWindow);
        if (tableUsers->columnCount() < 7)
            tableUsers->setColumnCount(7);
        ...
        tableUsers->setHorizontalHeaderItem(5, __qtablewidgetitem5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        tableUsers->setHorizontalHeaderItem(6, __qtablewidgetitem6);
        tableUsers->setObjectName("tableUsers");
        tableUsers->setStyleSheet(QString::fromUtf8("\n"
"       QTableWidget {\n"
"           font-size: 13px;\n"
"           background-color: white;\n"
...
"              min-width: 18px;\n"
"          }\n"
"          QTableWidget QCheckBox:checked {\n"
"              color: #3a6ea5;\n"
"          }\n"
"      "));
        tableUsers->setSizeAdjustPolicy(QAbstractScrollArea::SizeAdjustPolicy::AdjustToContents);
        tableUsers->setAlternatingRowColors(true);
        tableUsers->setSelectionMode(QAbstractItemView::SelectionMode::SingleSelection);
        ...
        paginationWidget = new QWidget(UserManageWindow);
...
"         "));
    ...
    {
        UserManageWindow->setWindowTitle(QCoreApplication::translate("UserManageWindow", "\347\224\250\346\210\267\347\256\241\347\220\206\346\250\241\345\235\227", nullptr));
        btnBack->setText(QCoreApplication::translate("UserManageWindow", "\350\277\224\345\233\236", nullptr));
        btnAdd->setText(QCoreApplication::translate("UserManageWindow", "\346\226\260\345\242\236\347\224\250\346\210\267", nullptr));
        btnEdit->setText(QCoreApplication::translate("UserManageWindow", "\347\274\226\350\276\221", nullptr));
        btnDelete->setText(QCoreApplication::translate("UserManageWindow", "\345\210\240\351\231\244", nullptr));
        lineSearch->setPlaceholderText(QCoreApplication::translate("UserManageWindow", "\350\276\223\345\205\245\347\224\250\346\210\267\345\220\215\343\200\201\347\234\237\345\256\236\345\247\223\345\220\215\347\255\211\345\205\263\351\224\256\350\257\215...", nullptr));
        btnSearch->setText(QCoreApplication::translate("UserManageWindow", "\346\220\234\347\264\242", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tableUsers->horizontalHeaderItem(1);
        ___qtablewidgetitem->setText(QCoreApplication::translate("UserManageWindow", "\347\224\250\346\210\267\345\220\215", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableUsers->horizontalHeaderItem(2);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("UserManageWindow", "\347\234\237\345\256\236\345\247\223\345\220\215", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableUsers->horizontalHeaderItem(3);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("UserManageWindow", "\346\211\200\345\261\236\346\234\272\346\236\204", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = tableUsers->horizontalHeaderItem(4);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("UserManageWindow", "\350\201\224\347\263\273\347\224\265\350\257\235", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = tableUsers->horizontalHeaderItem(5);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("UserManageWindow", "\347\212\266\346\200\201", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = tableUsers->horizontalHeaderItem(6);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("UserManageWindow", "\346\235\203\351\231\220", nullptr));
        labelPageInfo->setText(QCoreApplication::translate("UserManageWindow", "\347\254\254 1 \351\241\265 / \345\205\261 1 \351\241\265 (10 \346\235\241)", nullptr));
        btnFirst->setText(QCoreApplication::translate("UserManageWindow", "\351\246\226\351\241\265", nullptr));
        btnPrev->setText(QCoreApplication::translate("UserManageWindow", "\344\270\212\344\270\200\351\241\265", nullptr));
        comboPage->setCurrentText(QString());
        btnNext->setText(QCoreApplication::translate("UserManageWindow", "\344\270\213\344\270\200\351\241\265", nullptr));
        btnLast->setText(QCoreApplication::translate("UserManageWindow", "\346\234\253\351\241\265", nullptr));
        comboPageSize->setItemText(0, QCoreApplication::translate("UserManageWindow", "10 \346\235\241/\351\241\265", nullptr));
        comboPageSize->setItemText(1, QCoreApplication::translate("UserManageWindow", "20 \346\235\241/\351\241\265", nullptr));
        comboPageSize->setItemText(2, QCoreApplication::translate("UserManageWindow", "50 \346\235\241/\351\241\265", nullptr));
        comboPageSize->setItemText(3, QCoreApplication::translate("UserManageWindow", "100 \346\235\241/\351\241\265", nullptr));
